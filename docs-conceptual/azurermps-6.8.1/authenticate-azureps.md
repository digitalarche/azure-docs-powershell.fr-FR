...
Les principaux de service sont des comptes Azure non interactifs. À l’instar des autres comptes d’utilisateur, leurs autorisations sont gérées avec Azure Active Directory. En accordant à un principal de service les autorisations nécessaires uniquement, vous vous assurez que vos scripts d’automatisation restent sécurisés.
