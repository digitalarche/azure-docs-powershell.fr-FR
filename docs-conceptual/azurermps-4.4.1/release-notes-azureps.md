...
* Calcul
  * Exécutez la fonctionnalité de la commande :
    - Nouvelle applet de commande : Invoke-AzureRmVMRunCommand appelle une commande Exécuter sur une machine virtuelle.
    - Nouvelle applet de commande : Get-AzureRmVMRunCommandDocument affiche les documents de commande Exécuter disponibles.
  ...
  * Fonction de mise à niveau propagée du groupe identique de machines virtuelles :
    - Nouvelle applet de commande : Start-AzureRmVmssRollingOSUpgrade appelle la mise à niveau propagée du système d’exploitation du groupe identique de machines virtuelles.
    - Nouvelle applet de commande : Set-AzureRmVmssRollingUpgradePolicy définit la stratégie de mise à niveau propagée du groupe identique de machines virtuelles.
    - Nouvelle applet de commande : Stop-AzureRmVmssRollingUpgrade annule la mise à niveau propagée du groupe identique de machines virtuelles
    - Nouvelle applet de commande : Get-AzureRmVmssRollingUpgrade affiche l’état de la mise à niveau propagé du groupe identique de machines virtuelles.
  ...
  * Fonctionnalité de chiffrement de disque VMSS :
    - Nouvelle applet de commande : Set-AzureRmVmssDiskEncryptionExtension active le chiffrement de disque sur le groupe identique de machines virtuelles.
    - Nouvelle applet de commande : Disable-AzureRmVmssDiskEncryption désactive le chiffrement de disque sur le groupe identique de machines virtuelles.
    - Nouvelle applet de commande : Get-AzureRmVmssDiskEncryptionStatus affiche l’état du chiffrement de disque du groupe identique de machines virtuelles.
    - Nouvelle applet de commande : Get-AzureRmVmssVMDiskEncryptionStatus affiche l’état du chiffrement de disque des machines virtuelles d’un groupe identique de machines virtuelles.
* ContainerInstance
...
* Réseau
  ...
  * Ajout de la prise en charge de paramètre SKU pour les adresses IP publiques et les équilibreurs de charge
    - Mise à jour de New-AzureRMLoadBalancer : Ajout du paramètre facultatif -Sku
    - Mise à jour de New-AzureRMPublicIpAddress : Ajout du paramètre facultatif -Sku
  * Ajout de la prise en charge du paramètre DisableOutboundSNAT pour les règles d’équilibrage de charge
    - Mise à jour de New-AzureRMLoadBalancerRuleConfig : Ajout du paramètre facultatif DisableOutboundSNAT
    - Mise à jour d’Add-AzureRMLoadBalancerRuleConfig : Ajout du paramètre facultatif DisableOutboundSNAT
    - Mise à jour de Set-AzureRMLoadBalancerRuleConfig : Ajout du paramètre facultatif DisableOutboundSNAT
  * Ajout de la prise en charge de IkeV2 P2S
    - Mise à jour de New-AzureRmVirtualNetworkGateway : Ajout du paramètre facultatif -VpnClientProtocol, valeur par défaut ["SSTP", "IkeV2"]
    - Mise à jour de Set-AzureRmVirtualNetworkGateway : Ajout du paramètre facultatif -VpnClientProtocol
  * Ajout de la prise en charge de règles MultiValued dans les règles de sécurité réseau et les règles de sécurité réseau efficaces
    - Mise à jour d’Add-AzureRmNetworkSecurityRuleConfig : Mise à jour des paramètres SourcePortRange, DestinationPortRange et SourceAddressPrefix pour accepter une liste de chaînes
    - Mise à jour de New-AzureRmNetworkSecurityRuleConfig : Mise à jour des paramètres SourcePortRange, DestinationPortRange et SourceAddressPrefix pour accepter une liste de chaînes
    - Mise à jour de Set-AzureRmNetworkSecurityRuleConfig : Mise à jour des paramètres SourcePortRange, DestinationPortRange et SourceAddressPrefix pour accepter une liste de chaînes
    - Mise à jour d’Add-AzureRmNetworkSecurityRuleConfig : Mise à jour des paramètres SourcePortRange, DestinationPortRange et SourceAddressPrefix pour accepter une liste de chaînes
    - Mise à jour de New-AzureRmNetworkSecurityGroup : Mise à jour du paramètre SecurityRules pour accepter les paramètres SourcePortRange, DestinationPortRange et SourceAddressPrefix, qui sont des listes de chaînes dans l’objet PSSecurityRule
    - Mise à jour de Get-AzureRmEffectiveNetworkSecurityGroup : Ajout du paramètre TagMap
    - Mise à jour de Get-AzureRmEffectiveNetworkSecurityGroup : Mise à jour de l’objet PSEffectiveSecurityRule retourné avec les paramètres SourcePortRange, DestinationPortRange et SourceAddressPrefix, qui sont des listes de chaînes.
  * Ajout de la prise en charge de la protection DDOS pour les réseaux virtuels
    - Mise à jour de New-AzureRmVirtualNetwork : Ajout des paramètres booléens EnableDDoSProtection et EnableVmProtection
  ...
  * Ajout de la prise en charge de l’équilibreur de charge interne à haute disponibilité
    - Mise à jour d’Add-AzureRmLoadBalancerRuleConfig : Ajout de la valeur All comme valeur acceptable pour le paramètre Protocol
    - Mise à jour de New-AzureRmLoadBalancerRuleConfig : Ajout de la valeur All comme valeur acceptable pour le paramètre Protocol
    - Mise à jour de Set-AzureRmLoadBalancerRuleConfig : Ajout de la valeur All comme valeur acceptable pour le paramètre Protocol
  * Ajout de la prise en charge de groupes de sécurité d’application
    ...
    - Mise à jour de New-AzureRmNetworkInterface : Ajout des paramètres optionnels ApplicationSecurityGroup et ApplicationSecurityGroupId
    - Mise à jour de New-AzureRmNetworkInterfaceIpConfig : Ajout des paramètres optionnels ApplicationSecurityGroup et ApplicationSecurityGroupId
    - Mise à jour de Add-AzureRmNetworkInterfaceIpConfig : Ajout des paramètres optionnels ApplicationSecurityGroup et ApplicationSecurityGroupId
    - Mise à jour de Set-AzureRmNetworkInterfaceIpConfig : Ajout des paramètres optionnels ApplicationSecurityGroup et ApplicationSecurityGroupId
    - Mise à jour de New-AzureRmNetworkSecurityRuleConfig : Ajout des paramètres optionnels SourceApplicationSecurityGroup, SourceApplicationSecurityGroupId, DestinationApplicationSecurityGroup et DestinationApplicationSecurityGroupId
    - Mise à jour d’Add-AzureRmNetworkSecurityRuleConfig : Ajout des paramètres optionnels SourceApplicationSecurityGroup, SourceApplicationSecurityGroupId, DestinationApplicationSecurityGroup et DestinationApplicationSecurityGroupId
    - Mise à jour de Set-AzureRmNetworkSecurityRuleConfig : Ajout des paramètres optionnels SourceApplicationSecurityGroup, SourceApplicationSecurityGroupId, DestinationApplicationSecurityGroup et DestinationApplicationSecurityGroupId
...
* Profil
  ...
  * Conservation des informations de connexion d’une session à l’autre, nouvelles cmdlets :
    - Enable-AzureRmContextAutosave : active la conservation des informations d’identification d’une session à l’autre.
    - Disable-AzureRmContextAutosave : désactive la conservation des informations d’identification d’une session à l’autre.
...
* Calcul
    ...
    * Fonctionnalité de diagnostic de démarrage VMSS :
        - Nouvelle applet de commande pour définir les diagnostics de démarrage de l’objet Vmss : Set-AzureRmVmssBootDiagnostics
...
* AnalysisServices
    * Ajout de nouvelles références SKU : B1, B2, S0
...
* Calcul
    ...
    * Set-AzureRmDiskUpdateImageReference : Applets de commande déconseillés
    * New-AzureRmSnapshotUpdateConfig
      * Paramètres déconseillés : CreateOption, StorageAccountId, ImageReference, SourceUri, SourceResourceId
    * Set-AzureRmSnapshotUpdateImageReference : Applets de commande dépréciées
* DataLakeStore
...
* Réseau
    * Get-AzureRmNetworkUsage : Nouvelle applet de commande pour afficher les détails de l’utilisation et de la capacité du réseau
...
* Profil
    ...
    * Send-Feedback
      * Activation de l’envoi de commentaires sans connexion
...
* SQL
    * Restore-AzureRmSqlDatabase : Mise à jour de l’exemple de documentation
* Stockage
...
* Insights
  ...
  - New-AzureRmAutoscaleRule
    + Le paramètre ScaleActionType a été étendu, il reçoit maintenant les valeurs suivantes : ChangeCount, PercentChangeCount, ExactCount.
...
* ServiceBus
  ...
  - Résolution de bogue : Les valeurs de propriété de file d’attente de ServiceBus étaient définies sur null, l’objet est utilisé en tant que paramètre d’entrée dans l’applet de commande Set-AzureRmServiceBusQueue pour mettre à jour la file d’attente.
...
* Storage
  ...
  - New/Set/Get-AzureRmStorageAccount : Le compte de stockage retourné contient un nouvel attribut, EnableHttpsTrafficOnly.
* Azure.Storage
