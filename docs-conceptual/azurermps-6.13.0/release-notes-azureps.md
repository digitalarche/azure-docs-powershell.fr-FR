...
---
## <a name="6130---november-2018"></a>6.13.0 - novembre 2018
...
## <a name="6120---november-2018"></a>6.12.0 - novembre 2018
#### <a name="azurermprofile"></a>AzureRM.Profile
* Mise à jour du code commun pour utiliser la dernière version de ClientRuntime
* Changement de nom du param TenantId dans la cmdlet Connect-AzureRmAccount en Tenant et ajout d’un alias pour TenantId
* Mise à jour de la description TenantId pour Connect-AzureRmAccount
...
* Correction du problème de levée de « Disconnect-AzureRmAccount » lorsqu’il n’y a pas de connexion
    - https://github.com/Azure/azure-powershell/issues/7167

#### <a name="azurermautomation"></a>AzureRM.Automation
* Changement du nom du fichier DLL de la cmdlet en Microsoft.Azure.Commands.Automation.dll

#### <a name="azurermcognitiveservices"></a>AzureRM.CognitiveServices
* Ajout de l’opération Get-AzureRmCognitiveServicesAccountSkus.

#### <a name="azurermcompute"></a>AzureRM.Compute
* Ajout des cmdlets Add-AzureRmVmssVMDataDisk et Remove-AzureRmVmssVMDataDisk
* Get-AzureRmVMImage affiche AutomaticOSUpgradeProperties
* Correction des valeurs des options -BootstrapOptions et -JsonAttribute de SetAzureRmVMChefExtension qui ne sont pas définies au format json.
...
* Correction du problème #7513 [Insights], les catégories de Set-AzureRMDiagnosticSetting doivent être spécifiées explicitement lors de la création des paramètres
...
#### <a name="azurermrecoveryservicesbackup"></a>AzureRM.RecoveryServices.Backup
* Ajout de la prise en charge des partages de fichiers Azure partages dans Recovery Services.

#### <a name="azurermresources"></a>AzureRM.Resources
* Correctif pour https://github.com/Azure/azure-powershell/issues/7402
    - Autorisation de l’énumération des ressources à l’aide du paramètre « ResourceId » pour « Get-AzureRmResource »
...
* Correction de « Add-AzureRmServiceFabricClusterCertificate »
...
* Correction de « Update-AzureRmServiceFabricDurability » afin de mettre à jour la configuration des clusters avant de démarrer l’opération VMSS CreateOrUpdate.
...
* Ajout de la prise en charge des règles de réseau virtuel
    - Get-AzureRmDataLakeStoreVirtualNetworkRule : Obtient ou liste la règle de réseau virtuel Azure Data Lake Store.
    ...
    - Remove-AzureRmDataLakeStoreVirtualNetworkRule : Supprime une règle de réseau virtuel Azure Data Lake Store.
...
* Ajout de nouvelles applets de commande pour la fonctionnalité : Pare-feu Azure via ARM
...
#### <a name="azurermwebsites"></a>AzureRM.Websites
* Ajout de deux nouvelles applets de commande : Get-AzureRmDeletedWebApp et Restore-AzureRmDeletedWebApp
...
* Mise à jour des applets de commande ci-dessous pour Application Gateway
    ...
    - Set-AzureRmApplicationGatewaySku : Ajout de nouvelles références (SKU) Standard_v2 et WAF_v2
...
* Ajout de la prise en charge des stratégies par le biais d’une URL REMARQUE : Les applets de commande suivantes seront dépréciées dans une version ultérieure
