...
Dans PowerShell 5, le magasin de certificats peut être géré et inspecté avec le module [PKI](/powershell/module/pkiclient). Pour PowerShell 6, le processus est plus complexe. Les scripts suivants montrent comment importer un certificat existant dans le magasin de certificats qui est accessible via PowerShell.

#### <a name="import-a-certificate-in-powershell-5"></a>Importer un certificat dans PowerShell 5
...
#### <a name="import-a-certificate-in-powershell-6"></a>Importer un certificat dans PowerShell 6
