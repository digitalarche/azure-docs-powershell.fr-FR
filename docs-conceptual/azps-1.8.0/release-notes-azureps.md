...
#### <a name="azcdn"></a><span data-ttu-id="b13c9-114">Az.Cdn</span><span class="sxs-lookup"><span data-stu-id="b13c9-114">Az.Cdn</span></span>
...
#### <a name="azeventhub"></a><span data-ttu-id="b13c9-128">Az.EventHub</span><span class="sxs-lookup"><span data-stu-id="b13c9-128">Az.EventHub</span></span>
...
#### <a name="aznetwork"></a><span data-ttu-id="b13c9-149">Az.Network</span><span class="sxs-lookup"><span data-stu-id="b13c9-149">Az.Network</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="b13c9-165">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="b13c9-165">Az.Resources</span></span>
...
#### <a name="azcompute"></a><span data-ttu-id="b13c9-198">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="b13c9-198">Az.Compute</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="b13c9-213">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="b13c9-213">Az.Sql</span></span>
...
* <span data-ttu-id="b13c9-234">Ajout de l’authentification interactive et par nom d’utilisateur/mot de passe pour Windows PowerShell 5.1 uniquement</span><span class="sxs-lookup"><span data-stu-id="b13c9-234">Added interactive and username/password authentication for Windows PowerShell 5.1 only</span></span>
...
#### <a name="azrecoveryservices"></a><span data-ttu-id="b13c9-250">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="b13c9-250">Az.RecoveryServices</span></span>
...
## <a name="150---march-2019"></a><span data-ttu-id="b13c9-268">1.5.0 - Mars 2019</span><span class="sxs-lookup"><span data-stu-id="b13c9-268">1.5.0 - March 2019</span></span>
...
#### <a name="aznetwork"></a><span data-ttu-id="b13c9-284">Az.Network</span><span class="sxs-lookup"><span data-stu-id="b13c9-284">Az.Network</span></span>
...
#### <a name="azstorage"></a><span data-ttu-id="b13c9-301">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="b13c9-301">Az.Storage</span></span>
...
#### <a name="azdatalakestore"></a><span data-ttu-id="b13c9-317">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b13c9-317">Az.DataLakeStore</span></span>
...
#### <a name="azmonitor"></a><span data-ttu-id="b13c9-337">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="b13c9-337">Az.Monitor</span></span>
...
#### <a name="azwebsites"></a><span data-ttu-id="b13c9-353">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="b13c9-353">Az.Websites</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="b13c9-371">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="b13c9-371">Az.Sql</span></span>
...
#### <a name="azaks"></a><span data-ttu-id="b13c9-387">Az.Aks</span><span class="sxs-lookup"><span data-stu-id="b13c9-387">Az.Aks</span></span>
...
#### <a name="aziothub"></a><span data-ttu-id="b13c9-406">Az.IotHub</span><span class="sxs-lookup"><span data-stu-id="b13c9-406">Az.IotHub</span></span>
...
## <a name="110---january-2019"></a><span data-ttu-id="b13c9-443">1.1.0 - janvier 2019</span><span class="sxs-lookup"><span data-stu-id="b13c9-443">1.1.0 - January 2019</span></span>
...
* <span data-ttu-id="b13c9-455">Mettre à jour les cmdlets suivantes pour prendre en charge un nouveau scénario dans la version d’API 2019-01-01</span><span class="sxs-lookup"><span data-stu-id="b13c9-455">Update the following cmdlets to support new scenario in 2019-01-01 API version</span></span>
    ...
    - <span data-ttu-id="b13c9-460">Update-AzureRmEventGridSubscription : Ajoutez les nouveaux paramètres facultatifs pour spécifier :</span><span class="sxs-lookup"><span data-stu-id="b13c9-460">Update-AzureRmEventGridSubscription: Add new optional parameters for specifying:</span></span>
        ...
        - <span data-ttu-id="b13c9-463">le point de terminaison de lettres mortes.</span><span class="sxs-lookup"><span data-stu-id="b13c9-463">Dead letter endpoint.</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="b13c9-479">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="b13c9-479">Az.Sql</span></span>
...
* <span data-ttu-id="b13c9-484">Création du jeton Sas de l’objet d’instantané blob avec le paramètre -FullUri, correction de l’Uri retournée pour correspondre à l’Uri de l’instantané</span><span class="sxs-lookup"><span data-stu-id="b13c9-484">Create Sas Token of Blob Snapshot Object with '-FullUri' parameter, fix the returned Uri to be the sanpshot Uri</span></span>
    - <span data-ttu-id="b13c9-485">New-AzStorageBlobSASToken</span><span class="sxs-lookup"><span data-stu-id="b13c9-485">New-AzStorageBlobSASToken</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="b13c9-486">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="b13c9-486">Az.Websites</span></span>
* <span data-ttu-id="b13c9-487">Correction d’un bogue d’analyse de date dans Get-AzDeletedWebApp</span><span class="sxs-lookup"><span data-stu-id="b13c9-487">Fixed a date parsing bug in 'Get-AzDeletedWebApp'</span></span>
* <span data-ttu-id="b13c9-488">Correction du problème de compatibilité descendante avec le module Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="b13c9-488">Fix backward compatibility issue with Az.Accounts module</span></span>

## <a name="100---december-2018"></a><span data-ttu-id="b13c9-489">1.0.0 - Décembre 2018</span><span class="sxs-lookup"><span data-stu-id="b13c9-489">1.0.0 - December 2018</span></span>
### <a name="general"></a><span data-ttu-id="b13c9-490">Généralités</span><span class="sxs-lookup"><span data-stu-id="b13c9-490">General</span></span>

- <span data-ttu-id="b13c9-491">Disponibilité générale du module Az</span><span class="sxs-lookup"><span data-stu-id="b13c9-491">General Availability of Az Module</span></span>
- <span data-ttu-id="b13c9-492">Aide en ligne pour chaque module</span><span class="sxs-lookup"><span data-stu-id="b13c9-492">Online help for each module</span></span>
- <span data-ttu-id="b13c9-493">Pour obtenir plus d’informations et une feuille de route, voir la [page d’annonce d’Az](https://aka.ms/azps-announce)</span><span class="sxs-lookup"><span data-stu-id="b13c9-493">For more details and a roadmap, see the [Az Announcement page](https://aka.ms/azps-announce)</span></span>
- <span data-ttu-id="b13c9-494">Voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations sur la migration à partir d’AzureRM</span><span class="sxs-lookup"><span data-stu-id="b13c9-494">See the [Migration Guide](https://aka.ms/azps-migration-guide) for information on migrating from AzureRM</span></span>

### <a name="azaccounts"></a><span data-ttu-id="b13c9-495">Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="b13c9-495">Az.Accounts</span></span>
- <span data-ttu-id="b13c9-496">Remplace Az.Profile</span><span class="sxs-lookup"><span data-stu-id="b13c9-496">Changed from Az.Profile</span></span>
- <span data-ttu-id="b13c9-497">Formats de tableau fixe pour les types de profil et de contexte</span><span class="sxs-lookup"><span data-stu-id="b13c9-497">Fixed table formats for profile and context types</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="b13c9-498">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b13c9-498">Az.ApiManagement</span></span>
- <span data-ttu-id="b13c9-499">Correctifs pour #7002</span><span class="sxs-lookup"><span data-stu-id="b13c9-499">Fixes for #7002</span></span>
- <span data-ttu-id="b13c9-500">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-500">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbatch"></a><span data-ttu-id="b13c9-501">Az.Batch</span><span class="sxs-lookup"><span data-stu-id="b13c9-501">Az.Batch</span></span>
- <span data-ttu-id="b13c9-502">Possibilité pour voir quelle version de l’agent de nœud Azure Batch s’exécute sur chacune des machines virtuelles dans un pool, via la nouvelle propriété `NodeAgentInformation` sur `PSComputeNode`.</span><span class="sxs-lookup"><span data-stu-id="b13c9-502">Added the ability to see what version of the Azure Batch Node Agent is running on each of the VMs in a pool, via the new `NodeAgentInformation` property on `PSComputeNode`.</span></span>
- <span data-ttu-id="b13c9-503">La valeur par défaut `Caching` pour `PSDataDisk` est désormais `ReadWrite` au lieu de `None`.</span><span class="sxs-lookup"><span data-stu-id="b13c9-503">The `Caching` default for `PSDataDisk` is now `ReadWrite` instead of `None`.</span></span>
- <span data-ttu-id="b13c9-504">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-504">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbilling"></a><span data-ttu-id="b13c9-505">Az.Billing</span><span class="sxs-lookup"><span data-stu-id="b13c9-505">Az.Billing</span></span>
- <span data-ttu-id="b13c9-506">Combine les cmdlets Billing, Consumption et UsageAggregates, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-506">Combines Billing, Consumption, and UsageAggregates cmdlets, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azcognitivservices"></a><span data-ttu-id="b13c9-507">Az.CognitivServices</span><span class="sxs-lookup"><span data-stu-id="b13c9-507">Az.CognitivServices</span></span>
- <span data-ttu-id="b13c9-508">Possibilité d’ajouter des compléments pour SkuName et Typem sur l’opération New-AzureRmCognitiveServicesAccount</span><span class="sxs-lookup"><span data-stu-id="b13c9-508">Add completers for SkuName and Typem available on New-AzureRmCognitiveServicesAccount operation</span></span>
- <span data-ttu-id="b13c9-509">Suppression du jeu de paramètres GetSkusWithAccountParamSetName de Get-AzCognitiveServicesAccountSkus</span><span class="sxs-lookup"><span data-stu-id="b13c9-509">Removed GetSkusWithAccountParamSetName parameter set from Get-AzCognitiveServicesAccountSkus</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="b13c9-510">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="b13c9-510">Az.ContainerInstance</span></span>
- <span data-ttu-id="b13c9-511">Ajout de la prise en charge de ManagedIdentity</span><span class="sxs-lookup"><span data-stu-id="b13c9-511">Added ManagedIdentity support</span></span>

### <a name="azdatalakeanalytics"></a><span data-ttu-id="b13c9-512">Az.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="b13c9-512">Az.DataLakeAnalytics</span></span>
- <span data-ttu-id="b13c9-513">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-513">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="b13c9-514">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b13c9-514">Az.DataLakeStore</span></span>
- <span data-ttu-id="b13c9-515">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-515">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azmonitor"></a><span data-ttu-id="b13c9-516">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="b13c9-516">Az.Monitor</span></span>
- <span data-ttu-id="b13c9-517">Remplacement du nom Az.Insights par Az.Monitor et autres changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-517">Renamed Az.Insights to Az.Monitor and other minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azkeyvault"></a><span data-ttu-id="b13c9-518">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b13c9-518">Az.KeyVault</span></span>
- <span data-ttu-id="b13c9-519">Suppression de la propriété déconseillée ’PurgeDisabled’ dans les types de sortie</span><span class="sxs-lookup"><span data-stu-id="b13c9-519">Removed the deprecated 'PurgeDisabled' property from output types</span></span>

### <a name="azmachinelearning"></a><span data-ttu-id="b13c9-520">Az.MachineLearning</span><span class="sxs-lookup"><span data-stu-id="b13c9-520">Az.MachineLearning</span></span>
- <span data-ttu-id="b13c9-521">Inclusion des cmdlets du module Az.MachineLearningCompute</span><span class="sxs-lookup"><span data-stu-id="b13c9-521">Included cmdlets from Az.MachineLearningCompute module</span></span>

### <a name="azmedia"></a><span data-ttu-id="b13c9-522">Az.Media</span><span class="sxs-lookup"><span data-stu-id="b13c9-522">Az.Media</span></span>
- <span data-ttu-id="b13c9-523">Suppression des alias -Tags déconseillés de New-AzMediaService</span><span class="sxs-lookup"><span data-stu-id="b13c9-523">Remove deprecated -Tags alias from New-AzMediaService</span></span>

### <a name="aznetwork"></a><span data-ttu-id="b13c9-524">Az.Network</span><span class="sxs-lookup"><span data-stu-id="b13c9-524">Az.Network</span></span>
<span data-ttu-id="b13c9-525">Ajout de la prise en charge de la configuration de RewriteRuleSets dans Application Gateway</span><span class="sxs-lookup"><span data-stu-id="b13c9-525">Added support for the configuring RewriteRuleSets in the Application Gateway</span></span>
    - <span data-ttu-id="b13c9-526">Ajout de nouvelles cmdlets :</span><span class="sxs-lookup"><span data-stu-id="b13c9-526">New cmdlets added:</span></span>
        - <span data-ttu-id="b13c9-527">Add-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="b13c9-527">Add-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="b13c9-528">Get-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="b13c9-528">Get-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="b13c9-529">New-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="b13c9-529">New-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="b13c9-530">Remove-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="b13c9-530">Remove-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="b13c9-531">Set-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="b13c9-531">Set-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="b13c9-532">New-AzureRmApplicationGatewayRewriteRule</span><span class="sxs-lookup"><span data-stu-id="b13c9-532">New-AzureRmApplicationGatewayRewriteRule</span></span>
        - <span data-ttu-id="b13c9-533">New-AzureRmApplicationGatewayRewriteRuleActionSet</span><span class="sxs-lookup"><span data-stu-id="b13c9-533">New-AzureRmApplicationGatewayRewriteRuleActionSet</span></span>
        - <span data-ttu-id="b13c9-534">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span><span class="sxs-lookup"><span data-stu-id="b13c9-534">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span></span>
    - <span data-ttu-id="b13c9-535">Cmdlets mises à jour avec le paramètre facultatif -RewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="b13c9-535">Cmdlets updated with optional parameter -RewriteRuleSet</span></span>
        - <span data-ttu-id="b13c9-536">New-AzureRmApplicationGateway</span><span class="sxs-lookup"><span data-stu-id="b13c9-536">New-AzureRmApplicationGateway</span></span>
        - <span data-ttu-id="b13c9-537">New-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="b13c9-537">New-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="b13c9-538">Add-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="b13c9-538">Add-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="b13c9-539">New-AzureRmApplicationGatewayPathRuleConfig</span><span class="sxs-lookup"><span data-stu-id="b13c9-539">New-AzureRmApplicationGatewayPathRuleConfig</span></span>
        - <span data-ttu-id="b13c9-540">Add-AzureRmApplicationGatewayUrlPathMapConfig</span><span class="sxs-lookup"><span data-stu-id="b13c9-540">Add-AzureRmApplicationGatewayUrlPathMapConfig</span></span>
        - <span data-ttu-id="b13c9-541">New-AzureRmApplicationGatewayUrlPathMapConfig Ajout de la prise en charge de KeyVault pour Application Gateway avec l’identité.</span><span class="sxs-lookup"><span data-stu-id="b13c9-541">New-AzureRmApplicationGatewayUrlPathMapConfig Added KeyVault Support to Application Gateway using Identity.</span></span>
    - <span data-ttu-id="b13c9-542">Mise à jour des cmdlets avec le paramètre facultatif -KeyVaultSecretId, -KeyVaultSecret</span><span class="sxs-lookup"><span data-stu-id="b13c9-542">Cmdlets updated with optonal parameter -KeyVaultSecretId, -KeyVaultSecret</span></span>
        - <span data-ttu-id="b13c9-543">Add-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="b13c9-543">Add-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="b13c9-544">New-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="b13c9-544">New-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="b13c9-545">Set-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="b13c9-545">Set-AzApplicationGatewaySslCertificate</span></span>
    - <span data-ttu-id="b13c9-546">Cmdlet New-AzApplicationGateway mise à jour avec le paramètre facultatif -UserAssignedIdentity</span><span class="sxs-lookup"><span data-stu-id="b13c9-546">New-AzApplicationGateway cmdlet updated with optional parameter -UserAssignedIdentity</span></span>
- <span data-ttu-id="b13c9-547">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-547">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azoperationalinsights"></a><span data-ttu-id="b13c9-548">Az.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="b13c9-548">Az.OperationalInsights</span></span>
- <span data-ttu-id="b13c9-549">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-549">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azprofile"></a><span data-ttu-id="b13c9-550">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="b13c9-550">Az.Profile</span></span>
- <span data-ttu-id="b13c9-551">Nom du module remplacé par Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="b13c9-551">Changed module name to Az.Accounts</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="b13c9-552">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="b13c9-552">Az.RecoveryServices</span></span>
- <span data-ttu-id="b13c9-553">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-553">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azresources"></a><span data-ttu-id="b13c9-554">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="b13c9-554">Az.Resources</span></span>
- <span data-ttu-id="b13c9-555">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-555">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="b13c9-556">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="b13c9-556">Az.ServiceFabric</span></span>
- <span data-ttu-id="b13c9-557">Prise en charge des certificats spécifiés par nom commun et empreinte</span><span class="sxs-lookup"><span data-stu-id="b13c9-557">Support specfying certificate by common name and thumbprint</span></span>
- <span data-ttu-id="b13c9-558">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-558">Mnor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azsignalr"></a><span data-ttu-id="b13c9-559">Az.SIgnalR</span><span class="sxs-lookup"><span data-stu-id="b13c9-559">Az.SIgnalR</span></span>
- <span data-ttu-id="b13c9-560">Disponibilité générale des cmdlets PowerShell pour SIgnalR</span><span class="sxs-lookup"><span data-stu-id="b13c9-560">General Availability for PowerShell cmdlets for SIgnalR</span></span>

### <a name="azsql"></a><span data-ttu-id="b13c9-561">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="b13c9-561">Az.Sql</span></span>
- <span data-ttu-id="b13c9-562">Ajout des nouveaux types de détection Data_Exfiltration et Unsafe_Action aux cmdlets de détection des menaces</span><span class="sxs-lookup"><span data-stu-id="b13c9-562">Added new Data_Exfiltration and Unsafe_Action detection types to Threat Detection's cmdlets</span></span>
- <span data-ttu-id="b13c9-563">Mise à jour des exemples de la documentation pour les cmdlets d’audit SQL</span><span class="sxs-lookup"><span data-stu-id="b13c9-563">Updated documentation examples for Sql Auditing cmdlets</span></span>
- <span data-ttu-id="b13c9-564">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-564">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azstorage"></a><span data-ttu-id="b13c9-565">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="b13c9-565">Az.Storage</span></span>
- <span data-ttu-id="b13c9-566">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-566">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azwebsites"></a><span data-ttu-id="b13c9-567">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="b13c9-567">Az.Websites</span></span>
- <span data-ttu-id="b13c9-568">Changements cassants mineurs, voir le [guide de migration](https://aka.ms/azps-migration-guide) pour plus d’informations</span><span class="sxs-lookup"><span data-stu-id="b13c9-568">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

## <a name="070---december-2018"></a><span data-ttu-id="b13c9-569">0.7.0 - Décembre 2018</span><span class="sxs-lookup"><span data-stu-id="b13c9-569">0.7.0 - December 2018</span></span>

### <a name="general"></a><span data-ttu-id="b13c9-570">Généralités</span><span class="sxs-lookup"><span data-stu-id="b13c9-570">General</span></span>

* <span data-ttu-id="b13c9-571">Changements mineurs pour la future transition d’AzureRM vers Az</span><span class="sxs-lookup"><span data-stu-id="b13c9-571">Minor changes for upcoming AzureRM to Az transition</span></span>

### <a name="azcompute"></a><span data-ttu-id="b13c9-572">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="b13c9-572">Az.Compute</span></span>

* <span data-ttu-id="b13c9-573">Ajout de la prise en charge d’UltraSSD et des images de la galerie dans les jeux de paramètres simples pour les cmdlets `New-AzVm(ss)`.</span><span class="sxs-lookup"><span data-stu-id="b13c9-573">Add support for UltraSSD and Gallery Images in the simple param sets for `New-AzVm(ss)` cmdlets.</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="b13c9-574">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b13c9-574">Az.DataLakeStore</span></span>

* <span data-ttu-id="b13c9-575">Correction de la barre oblique de fin dans le domaine du compte ADLS</span><span class="sxs-lookup"><span data-stu-id="b13c9-575">Fix the trailing slash of the domain of adls account</span></span>

### <a name="azfrontdoor"></a><span data-ttu-id="b13c9-576">Az.FrontDoor</span><span class="sxs-lookup"><span data-stu-id="b13c9-576">Az.FrontDoor</span></span>

* <span data-ttu-id="b13c9-577">Correction de certains liens rompus</span><span class="sxs-lookup"><span data-stu-id="b13c9-577">Fixed some broken links</span></span>
    - <span data-ttu-id="b13c9-578">Dans les articles New-AzureRmFrontDoor et Set-AzureRmFrontDoor, correction du lien vers l’article sur la cmdlet New-AzureRmFrontDoorHealthProbeSettingObject.</span><span class="sxs-lookup"><span data-stu-id="b13c9-578">In the New-AzureRmFrontDoor and Set-AzureRmFrontDoor articles, fixed the link to the New-AzureRmFrontDoorHealthProbeSettingObject cmdlet article.</span></span>
    - <span data-ttu-id="b13c9-579">Dans l’article New-AzureRmFrontDoorManagedRuleObject, correction du lien vers l’article sur la cmdlet New-AzureRmFrontDoorRuleGroupOverrideObject.</span><span class="sxs-lookup"><span data-stu-id="b13c9-579">In the New-AzureRmFrontDoorManagedRuleObject article, fixed the link to the New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet article.</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="b13c9-580">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="b13c9-580">Az.RecoveryServices</span></span>

* <span data-ttu-id="b13c9-581">Ajout de validations du côté client pour les opérations de restauration sur un partage de fichiers Azure.</span><span class="sxs-lookup"><span data-stu-id="b13c9-581">Added client side validations for Azure File Share restore operations.</span></span>
* <span data-ttu-id="b13c9-582">Caractère facultatif de storageAccountName et storageAccountResourceGroupName pour la restauration AFS.</span><span class="sxs-lookup"><span data-stu-id="b13c9-582">Made storageAccountName and storageAccountResourceGroupName optional for afs restore.</span></span>

### <a name="azresources"></a><span data-ttu-id="b13c9-583">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="b13c9-583">Az.Resources</span></span>

* <span data-ttu-id="b13c9-584">Correctif pour https://github.com/Azure/azure-powershell/issues/7679</span><span class="sxs-lookup"><span data-stu-id="b13c9-584">Fix for https://github.com/Azure/azure-powershell/issues/7679</span></span>
    - <span data-ttu-id="b13c9-585">Mise à jour de Get-AzureRmRoleAssignment pour utiliser l’étendue de l’abonnement si elle est fournie lors de la demande des administrateurs classiques.</span><span class="sxs-lookup"><span data-stu-id="b13c9-585">Update Get-AzureRmRoleAssignment to use the subscription scope if it is provided when requesting classic administrators.</span></span>

### <a name="azsql"></a><span data-ttu-id="b13c9-586">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="b13c9-586">Az.Sql</span></span>

* <span data-ttu-id="b13c9-587">Changements mineurs pour la future transition d’AzureRM vers Az</span><span class="sxs-lookup"><span data-stu-id="b13c9-587">Minor changes for upcoming AzureRM to Az transition</span></span>
* <span data-ttu-id="b13c9-588">Correction d’un problème lors de l’utilisation de Get-AzureRmSqlDatabaseVulnerabilityAssessment avec le principal DotNet</span><span class="sxs-lookup"><span data-stu-id="b13c9-588">Fixed issue with using Get-AzureRmSqlDatabaseVulnerabilityAssessment with DotNet core</span></span>
* <span data-ttu-id="b13c9-589">Modification de la documentation sur les messages d’aide relatifs aux cmdlets d’audit SQL.</span><span class="sxs-lookup"><span data-stu-id="b13c9-589">Modified documentation of help messages related to SQL Auditing cmdlets.</span></span>

### <a name="azstorage"></a><span data-ttu-id="b13c9-590">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="b13c9-590">Az.Storage</span></span>

* <span data-ttu-id="b13c9-591">Ajout de -EnableHierarchicalNamespace à New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="b13c9-591">Add -EnableHierarchicalNamespace to New-AzureRmStorageAccount</span></span>
* <span data-ttu-id="b13c9-592">Correction d’un problème où la cmdlet de copie de fichier ne peut pas réutiliser le contexte source dans la destination sans entrée -DestContext</span><span class="sxs-lookup"><span data-stu-id="b13c9-592">Fix issue that Copy File cmdlet can't reuse source context in destination when not input -DestContext</span></span>
    - <span data-ttu-id="b13c9-593">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="b13c9-593">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="b13c9-594">Prise en charge de la configuration du site Web statique</span><span class="sxs-lookup"><span data-stu-id="b13c9-594">Support Static Website configuration</span></span>
    - <span data-ttu-id="b13c9-595">Enable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="b13c9-595">Enable-AzureStorageStaticWebsite</span></span>
    - <span data-ttu-id="b13c9-596">Disable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="b13c9-596">Disable-AzureStorageStaticWebsite</span></span>

### <a name="azwebsites"></a><span data-ttu-id="b13c9-597">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="b13c9-597">Az.Websites</span></span>

* <span data-ttu-id="b13c9-598">Set-AzureRmWebApp et Set-AzureRmWebAppSlot</span><span class="sxs-lookup"><span data-stu-id="b13c9-598">Set-AzureRmWebApp and Set-AzureRmWebAppSlot</span></span> 
    - <span data-ttu-id="b13c9-599">Nouveau paramètre (-AzureStoragePath) ajouté pour spécifier que des chemins d’accès au stockage Azure doivent être montés dans les applications de conteneurs Windows et Linux.</span><span class="sxs-lookup"><span data-stu-id="b13c9-599">New parameter (-AzureStoragePath) added to specify Azure Storage paths to be mounted in Windows and Linux container apps.</span></span> <span data-ttu-id="b13c9-600">Utilisation de la sortie de la nouvelle cmdlet New-AzureRmWebAppAzureStoragePath en tant que paramètre pour définir les chemins d’accès au stockage Azure.</span><span class="sxs-lookup"><span data-stu-id="b13c9-600">Use the output of the new cmdlet New-AzureRmWebAppAzureStoragePath as a parameter to set the Azure Storage paths.</span></span>

## <a name="061---november-2018"></a><span data-ttu-id="b13c9-601">0.6.1 - Novembre 2018</span><span class="sxs-lookup"><span data-stu-id="b13c9-601">0.6.1 - November 2018</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="b13c9-602">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b13c9-602">Az.ApiManagement</span></span>
* <span data-ttu-id="b13c9-603">Mise à jour des dépendances pour le problème de mappage de types</span><span class="sxs-lookup"><span data-stu-id="b13c9-603">Update dependencies for type mapping issue</span></span>

### <a name="azautomation"></a><span data-ttu-id="b13c9-604">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="b13c9-604">Az.Automation</span></span>
* <span data-ttu-id="b13c9-605">Cmdlets Azure Automation basées sur Swagger</span><span class="sxs-lookup"><span data-stu-id="b13c9-605">Swagger based Azure Automation cmdlets</span></span>
* <span data-ttu-id="b13c9-606">Ajout des cmdlets Update Management</span><span class="sxs-lookup"><span data-stu-id="b13c9-606">Added Update Management cmdlets</span></span>
* <span data-ttu-id="b13c9-607">Ajout des cmdlets de contrôle de code source</span><span class="sxs-lookup"><span data-stu-id="b13c9-607">Added Source Control cmdlets</span></span>
* <span data-ttu-id="b13c9-608">Ajout de la cmdlet Remove-AzureRmAutomationHybridWorkerGroup</span><span class="sxs-lookup"><span data-stu-id="b13c9-608">Added Remove-AzureRmAutomationHybridWorkerGroup cmdlet</span></span>
* <span data-ttu-id="b13c9-609">Correction de la commande de nœud d’inscription DSC</span><span class="sxs-lookup"><span data-stu-id="b13c9-609">Fixed the DSC Register Node command</span></span>

### <a name="azcompute"></a><span data-ttu-id="b13c9-610">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="b13c9-610">Az.Compute</span></span>
* <span data-ttu-id="b13c9-611">Résolution du problème d’identité pour l’identité SystemAssigned</span><span class="sxs-lookup"><span data-stu-id="b13c9-611">Fixed identity issue for SystemAssigned identity</span></span>
* <span data-ttu-id="b13c9-612">Mise à jour des dépendances pour le problème de mappage de types</span><span class="sxs-lookup"><span data-stu-id="b13c9-612">Update dependencies for type mapping issue</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="b13c9-613">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="b13c9-613">Az.ContainerInstance</span></span>
* <span data-ttu-id="b13c9-614">Mise à jour des dépendances pour le problème de mappage de types</span><span class="sxs-lookup"><span data-stu-id="b13c9-614">Update dependencies for type mapping issue</span></span>

### <a name="azmarketplaceordering"></a><span data-ttu-id="b13c9-615">Az.MarketplaceOrdering</span><span class="sxs-lookup"><span data-stu-id="b13c9-615">Az.MarketplaceOrdering</span></span>
* <span data-ttu-id="b13c9-616">Mise à jour de la description d’exemples pour les cmdlets marketplace</span><span class="sxs-lookup"><span data-stu-id="b13c9-616">update the examples description for marketplace cmdlets</span></span>

### <a name="aznetwork"></a><span data-ttu-id="b13c9-617">Az.Network</span><span class="sxs-lookup"><span data-stu-id="b13c9-617">Az.Network</span></span>
* <span data-ttu-id="b13c9-618">Ajout des cmdlets New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span><span class="sxs-lookup"><span data-stu-id="b13c9-618">Added cmdlet New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span></span>
* <span data-ttu-id="b13c9-619">Nouvel ajout d’ICMP aux protocoles réseau AzureFirewall pris en charge</span><span class="sxs-lookup"><span data-stu-id="b13c9-619">Added ICMP back to supported AzureFirewall Network Protocols</span></span>
* <span data-ttu-id="b13c9-620">Mise à jour de la cmdlet Test-AzureRmNetworkWatcherConnectivity, ajout de validation sur l’ID de destination, l’adresse et le port.</span><span class="sxs-lookup"><span data-stu-id="b13c9-620">Update cmdlet Test-AzureRmNetworkWatcherConnectivity, add validation on destination id, address and port.</span></span> 
* <span data-ttu-id="b13c9-621">Résolution des problèmes avec l’utilisation de la mémoire dans la carte VirtualNetwork</span><span class="sxs-lookup"><span data-stu-id="b13c9-621">Fix issues with memory usage in VirtualNetwork map</span></span>

### <a name="azrecoveryservicesbackup"></a><span data-ttu-id="b13c9-622">Az.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="b13c9-622">Az.RecoveryServices.Backup</span></span>
* <span data-ttu-id="b13c9-623">Correction de la stratégie de modification pour un partage de fichiers protégé.</span><span class="sxs-lookup"><span data-stu-id="b13c9-623">Fix for modifying policy for a protected file share.</span></span>
* <span data-ttu-id="b13c9-624">Conversion du fuseau horaire de stratégie en majuscules.</span><span class="sxs-lookup"><span data-stu-id="b13c9-624">Converted policy timezone to uppercase.</span></span>

### <a name="azrecoveryservicessiterecovery"></a><span data-ttu-id="b13c9-625">Az.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="b13c9-625">Az.RecoveryServices.SiteRecovery</span></span>
* <span data-ttu-id="b13c9-626">Correction de l’exemple dans New-AzureRmRecoveryServicesAsrProtectableItem</span><span class="sxs-lookup"><span data-stu-id="b13c9-626">Corrected example in New-AzureRmRecoveryServicesAsrProtectableItem</span></span>
* <span data-ttu-id="b13c9-627">Mise à jour des dépendances pour le problème de mappage de types</span><span class="sxs-lookup"><span data-stu-id="b13c9-627">Update dependencies for type mapping issue</span></span>

### <a name="azrelay"></a><span data-ttu-id="b13c9-628">Az.Relay</span><span class="sxs-lookup"><span data-stu-id="b13c9-628">Az.Relay</span></span>
* <span data-ttu-id="b13c9-629">Ajout du Parameter -KeyValue à la cmdlet New-AzureRmEventHubKey, qui permet à l’utilisateur de fournir KeyValue.</span><span class="sxs-lookup"><span data-stu-id="b13c9-629">Added optional Parameter -KeyValue to New-AzureRmRelayKey cmdlet, which enables user to provide KeyValue.</span></span>

### <a name="azresources"></a><span data-ttu-id="b13c9-630">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="b13c9-630">Az.Resources</span></span>
* <span data-ttu-id="b13c9-631">Mise à jour de la documentation d’aide pour des paramètres relatifs à l’identité de ressource dans `New-AzureRmPolicyAssignment` et `Set-AzureRmPolicyAssignment`</span><span class="sxs-lookup"><span data-stu-id="b13c9-631">Update help documentation for resource identity related parameters in `New-AzureRmPolicyAssignment` and `Set-AzureRmPolicyAssignment`</span></span>
* <span data-ttu-id="b13c9-632">Ajout d’un exemple pour New-AzureRmPolicyDefinition qui utilise -Metadata</span><span class="sxs-lookup"><span data-stu-id="b13c9-632">Add an example for New-AzureRmPolicyDefinition that uses -Metadata</span></span>
* <span data-ttu-id="b13c9-633">Correction pour permettre la conservation de la casse dans les clés Tag dans NetStandard: #7678 #7703</span><span class="sxs-lookup"><span data-stu-id="b13c9-633">Fix to allow case preservation in Tag keys in NetStandard: #7678 #7703</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="b13c9-634">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="b13c9-634">Az.ServiceFabric</span></span>
* <span data-ttu-id="b13c9-635">Ajout de messages d’obsolescence pour les changements cassants à venir</span><span class="sxs-lookup"><span data-stu-id="b13c9-635">Add deprecation messages for upcoming breaking changes</span></span>

### <a name="azsql"></a><span data-ttu-id="b13c9-636">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="b13c9-636">Az.Sql</span></span>
* <span data-ttu-id="b13c9-637">Ajout de nouvelles applets de commande pour les opérations CRUD sur Azure Sql Database Managed Instance et Azure Sql Managed Database</span><span class="sxs-lookup"><span data-stu-id="b13c9-637">Added new cmdlets for CRUD operations on Azure Sql Database Managed Instance and Azure Sql Managed Database</span></span>
    - <span data-ttu-id="b13c9-638">Get-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="b13c9-638">Get-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="b13c9-639">New-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="b13c9-639">New-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="b13c9-640">Set-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="b13c9-640">Set-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="b13c9-641">Remove-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="b13c9-641">Remove-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="b13c9-642">Get-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="b13c9-642">Get-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="b13c9-643">New-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="b13c9-643">New-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="b13c9-644">Restore-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="b13c9-644">Restore-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="b13c9-645">Remove-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="b13c9-645">Remove-AzureRmSqlInstanceDatabase</span></span>
* <span data-ttu-id="b13c9-646">Activation de la gestion de stratégie d’audit étendue sur un serveur ou une base de données.</span><span class="sxs-lookup"><span data-stu-id="b13c9-646">Enabled Extended Auditing Policy management on a server or a database.</span></span>
    - <span data-ttu-id="b13c9-647">Un nouveau paramètre (PredicateExpression) a été ajouté pour activer le filtrage des journaux d’audit.</span><span class="sxs-lookup"><span data-stu-id="b13c9-647">New parameter (PredicateExpression) was added to enable filtering of audit logs.</span></span>
    - <span data-ttu-id="b13c9-648">Des cmdlets ont été modifiées pour utiliser des clients SQL plutôt que des clients hérités.</span><span class="sxs-lookup"><span data-stu-id="b13c9-648">Cmdlets were modified to use SQL clients instead of Legacy clients.</span></span>
    - <span data-ttu-id="b13c9-649">Set-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="b13c9-649">Set-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="b13c9-650">Get-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="b13c9-650">Get-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="b13c9-651">Set-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="b13c9-651">Set-AzureRmSqlDatabaseAuditing.</span></span>
    - <span data-ttu-id="b13c9-652">Get-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="b13c9-652">Get-AzureRmSqlDatabaseAuditing.</span></span>
* <span data-ttu-id="b13c9-653">Correction du problème relatif à l’utilisation de Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings avec un ensemble de paramètres de nom de compte de stockage</span><span class="sxs-lookup"><span data-stu-id="b13c9-653">Fixed issue with using Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings with storage account name parameter set</span></span>

## <a name="050---november-2018"></a><span data-ttu-id="b13c9-654">0.5.0 - Novembre 2018</span><span class="sxs-lookup"><span data-stu-id="b13c9-654">0.5.0 - November 2018</span></span>
#### <a name="general"></a><span data-ttu-id="b13c9-655">Généralités</span><span class="sxs-lookup"><span data-stu-id="b13c9-655">General</span></span>
* <span data-ttu-id="b13c9-656">Ajout de compléments de ressources à de nombreuses cmdlets principales, ce qui permet de parcourir les noms des ressources existantes ave la touche Tabulation lors de l’appel des cmdlets de manière interactive</span><span class="sxs-lookup"><span data-stu-id="b13c9-656">Added Resource Completers to many core cmdlets - these alloow you to tab through existing resource names when invoking cmdlets interactively</span></span>

#### <a name="azprofile"></a><span data-ttu-id="b13c9-657">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="b13c9-657">Az.Profile</span></span>
* <span data-ttu-id="b13c9-658">Mise à jour du code commun pour utiliser la dernière version de ClientRuntime</span><span class="sxs-lookup"><span data-stu-id="b13c9-658">Update common code to use latest version of ClientRuntime</span></span>
* <span data-ttu-id="b13c9-659">Changement de nom du paramètre TenantId dans la cmdlet Connect-AzAccount en Tenant et ajout d’un alias pour TenantId</span><span class="sxs-lookup"><span data-stu-id="b13c9-659">Rename param TenantId in cmdlet Connect-AzAccount to Tenant and add an alias for TenantId</span></span>
* <span data-ttu-id="b13c9-660">Mise à jour de la description TenantId pour Connect-AzAccount</span><span class="sxs-lookup"><span data-stu-id="b13c9-660">Updated TenantId description for Connect-AzAccount</span></span>
* <span data-ttu-id="b13c9-661">Correction du message d’erreur en cas d’échec de connexion lorsqu’un domaine de locataire est fourni</span><span class="sxs-lookup"><span data-stu-id="b13c9-661">Fix error message for failed login when providing tenant domain</span></span>
    - https://github.com/Azure/azure-powershell/issues/6936
* <span data-ttu-id="b13c9-662">Résolution du conflit avec le nom de contexte pour les comptes dont le locataire ne dispose d’aucun abonnement</span><span class="sxs-lookup"><span data-stu-id="b13c9-662">Fix issue with context name clashing for accounts with no subscriptions in tenant</span></span>
    - https://github.com/Azure/azure-powershell/issues/7453
* <span data-ttu-id="b13c9-663">Correction du problème avec les points de terminaison DataLake lors de l’utilisation de MSI</span><span class="sxs-lookup"><span data-stu-id="b13c9-663">Fix issue with DataLake endpoints when using MSI</span></span>
    - https://github.com/Azure/azure-powershell/issues/7462
* <span data-ttu-id="b13c9-664">Correction du problème de levée de « Disconnect-Connect-AzAccount » lorsqu’il n’y a pas de connexion</span><span class="sxs-lookup"><span data-stu-id="b13c9-664">Fix issue where 'Disconnect-AzAccount' would throw if not connected</span></span>
    - https://github.com/Azure/azure-powershell/issues/7167

#### <a name="azcognitiveservices"></a><span data-ttu-id="b13c9-665">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="b13c9-665">Az.CognitiveServices</span></span>
* <span data-ttu-id="b13c9-666">Ajout de l’opération Get-AzCognitiveServicesAccountSkus.</span><span class="sxs-lookup"><span data-stu-id="b13c9-666">Add Get-AzCognitiveServicesAccountSkus operation.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="b13c9-667">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="b13c9-667">Az.Compute</span></span>
* <span data-ttu-id="b13c9-668">Ajout des cmdlets Add-AzVmssVMDataDisk et Remove-AzVmssVMDataDisk</span><span class="sxs-lookup"><span data-stu-id="b13c9-668">Add Add-AzVmssVMDataDisk and Remove-AzVmssVMDataDisk cmdlets</span></span>
* <span data-ttu-id="b13c9-669">Get-AzVMImage affiche AutomaticOSUpgradeProperties</span><span class="sxs-lookup"><span data-stu-id="b13c9-669">Get-AzVMImage shows AutomaticOSUpgradeProperties</span></span>
* <span data-ttu-id="b13c9-670">Correction des valeurs des options -BootstrapOptions et -JsonAttribute de SetAzVMChefExtension qui ne sont pas définies au format JSON.</span><span class="sxs-lookup"><span data-stu-id="b13c9-670">Fixed SetAzVMChefExtension -BootstrapOptions and -JsonAttribute option values are not setting in json format.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="b13c9-671">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b13c9-671">Az.DataLakeStore</span></span>
* <span data-ttu-id="b13c9-672">Mise à jour du package DataLake vers la version 1.1.10.</span><span class="sxs-lookup"><span data-stu-id="b13c9-672">Update the DataLake package to 1.1.10.</span></span>
* <span data-ttu-id="b13c9-673">Ajout de la valeur de concurrence par défaut aux opérations multithread.</span><span class="sxs-lookup"><span data-stu-id="b13c9-673">Add default Concurrency to multithreaded operations.</span></span>

#### <a name="azinsights"></a><span data-ttu-id="b13c9-674">Az.Insights</span><span class="sxs-lookup"><span data-stu-id="b13c9-674">Az.Insights</span></span>
* <span data-ttu-id="b13c9-675">Correction du problème #7267 (zone de mise à l’échelle)</span><span class="sxs-lookup"><span data-stu-id="b13c9-675">Fixed issue #7267 (Autoscale area)</span></span>
    - <span data-ttu-id="b13c9-676">Problèmes lorsqu’une nouvelle règle de mise à l’échelle est créée sans avoir défini correctement les paramètres énumérés (toujours définir leurs valeurs par défaut).</span><span class="sxs-lookup"><span data-stu-id="b13c9-676">Issues with creating a new autoscale rule not properly setting enumerated parameters (would always set them to the default value).</span></span>
* <span data-ttu-id="b13c9-677">Correction du problème #7513 [Insights], les catégories de Set-AzDiagnosticSetting doivent être spécifiées explicitement lors de la création des paramètres</span><span class="sxs-lookup"><span data-stu-id="b13c9-677">Fixed issue #7513 [Insights] Set-AzDiagnosticSetting requires explicit specification of categories during creation of setting</span></span>
    - <span data-ttu-id="b13c9-678">À présent, l’activation des catégories de la cmdlet ne doit plus être indiquée explicitement lors de la création. Par exemple, cela fonctionne comme documenté</span><span class="sxs-lookup"><span data-stu-id="b13c9-678">Now the cmdlet does not require explicit indication of the categories to enable during creation, i.e. it works as it is documented</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="b13c9-679">Az.Network</span><span class="sxs-lookup"><span data-stu-id="b13c9-679">Az.Network</span></span>
* <span data-ttu-id="b13c9-680">Modification du type d’homologation en paramètre obligatoire pour les cmdlets suivantes : -</span><span class="sxs-lookup"><span data-stu-id="b13c9-680">Changed PeeringType to be a mandatory parameter for the following cmdlets:-</span></span>
    - <span data-ttu-id="b13c9-681">Get-AzExpressRouteCircuitRouteTable</span><span class="sxs-lookup"><span data-stu-id="b13c9-681">Get-AzExpressRouteCircuitRouteTable</span></span>
    - <span data-ttu-id="b13c9-682">Get-AzExpressRouteCircuitARPTable</span><span class="sxs-lookup"><span data-stu-id="b13c9-682">Get-AzExpressRouteCircuitARPTable</span></span>
    - <span data-ttu-id="b13c9-683">Get-AzExpressRouteCircuitRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="b13c9-683">Get-AzExpressRouteCircuitRouteTableSummary</span></span>
    - <span data-ttu-id="b13c9-684">Get-AzExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="b13c9-684">Get-AzExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="b13c9-685">Get-AzExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="b13c9-685">Get-AzExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="b13c9-686">Get-AzExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="b13c9-686">Get-AzExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azpolicyinsights"></a><span data-ttu-id="b13c9-687">Az.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="b13c9-687">Az.PolicyInsights</span></span>
* <span data-ttu-id="b13c9-688">Ajout des cmdlets de correction des stratégies</span><span class="sxs-lookup"><span data-stu-id="b13c9-688">Added policy remediation cmdlets</span></span>

#### <a name="azresources"></a><span data-ttu-id="b13c9-689">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="b13c9-689">Az.Resources</span></span>
* <span data-ttu-id="b13c9-690">Correctif pour https://github.com/Azure/azure-powershell/issues/7402</span><span class="sxs-lookup"><span data-stu-id="b13c9-690">Fix for https://github.com/Azure/azure-powershell/issues/7402</span></span>
    - <span data-ttu-id="b13c9-691">Autorisation de l’énumération des ressources à l’aide du paramètre « ResourceId » pour « Get-AzResource »</span><span class="sxs-lookup"><span data-stu-id="b13c9-691">Allow listing resources using the '-ResourceId' parameter for 'Get-AzResource'</span></span>

#### <a name="azservicebus"></a><span data-ttu-id="b13c9-692">Az.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="b13c9-692">Az.ServiceBus</span></span>
* <span data-ttu-id="b13c9-693">Ajout de la propriété en lecture seule MigrationState à PSServiceBusMigrationConfigurationAttributes afin d’aider à connaître l’état de la migration.</span><span class="sxs-lookup"><span data-stu-id="b13c9-693">Added MigrationState read-only property to PSServiceBusMigrationConfigurationAttributes which will help to know the Migration state.</span></span>

#### <a name="azservicefabric"></a><span data-ttu-id="b13c9-694">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="b13c9-694">Az.ServiceFabric</span></span>
* <span data-ttu-id="b13c9-695">Correction de l’ajout de certificat au VMSS Linux.</span><span class="sxs-lookup"><span data-stu-id="b13c9-695">Fix add certificate to Linux Vmss.</span></span>
* <span data-ttu-id="b13c9-696">Correction de « Add-AzServiceFabricClusterCertificate »</span><span class="sxs-lookup"><span data-stu-id="b13c9-696">Fix 'Add-AzServiceFabricClusterCertificate'</span></span>
    - <span data-ttu-id="b13c9-697">Utilisation de la bonne empreinte numérique d’un nouveau certificat (Azure/service-fabric-issues#932).</span><span class="sxs-lookup"><span data-stu-id="b13c9-697">Using correct thumbprint from new certificate (Azure/service-fabric-issues#932).</span></span>
    - <span data-ttu-id="b13c9-698">Affichage correct des exceptions (Azure/service-fabric-issues#1054).</span><span class="sxs-lookup"><span data-stu-id="b13c9-698">Display exception correctly (Azure/service-fabric-issues#1054).</span></span>
* <span data-ttu-id="b13c9-699">Correction de « Update-AzServiceFabricDurability » afin de mettre à jour la configuration des clusters avant de démarrer l’opération VMSS CreateOrUpdate.</span><span class="sxs-lookup"><span data-stu-id="b13c9-699">Fix 'Update-AzServiceFabricDurability' to update cluster configuration before starting Vmss CreateOrUpdate operation.</span></span>

## <a name="040---october-2018"></a><span data-ttu-id="b13c9-700">0.4.0 - Octobre 2018</span><span class="sxs-lookup"><span data-stu-id="b13c9-700">0.4.0 - October 2018</span></span>
#### <a name="azprofile"></a><span data-ttu-id="b13c9-701">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="b13c9-701">Az.Profile</span></span>
* <span data-ttu-id="b13c9-702">Problème résolu avec Get-AzSubscription dans CloudShell</span><span class="sxs-lookup"><span data-stu-id="b13c9-702">Fix issue with Get-AzSubscription in CloudShell</span></span>
* <span data-ttu-id="b13c9-703">Mise à jour du code commun pour utiliser la dernière version de ClientRuntime</span><span class="sxs-lookup"><span data-stu-id="b13c9-703">Update common code to use latest version of ClientRuntime</span></span>

#### <a name="azcompute"></a><span data-ttu-id="b13c9-704">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="b13c9-704">Az.Compute</span></span>
* <span data-ttu-id="b13c9-705">Ajout de nouvelles tailles à la liste blanche des tailles de machine virtuelle pour lesquelles une mise en réseau accélérée sera activée lors de l’utilisation du jeu de paramètres simple pour « New-AzVm »</span><span class="sxs-lookup"><span data-stu-id="b13c9-705">Added new sizes to the whitelist of VM sizes for which accelerated networking will be turned on when using the simple param set for 'New-AzVm'</span></span>
* <span data-ttu-id="b13c9-706">Ajout d’un complémenteur d’argument ResourceName pour tous les applets de commande.</span><span class="sxs-lookup"><span data-stu-id="b13c9-706">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="b13c9-707">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b13c9-707">Az.DataLakeStore</span></span>
* <span data-ttu-id="b13c9-708">Ajout de la prise en charge des règles de réseau virtuel</span><span class="sxs-lookup"><span data-stu-id="b13c9-708">Adding support for Virtual Network Rules</span></span>
    - <span data-ttu-id="b13c9-709">Get-AzDataLakeStoreVirtualNetworkRule : Obtient ou liste la règle de réseau virtuel Azure Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="b13c9-709">Get-AzDataLakeStoreVirtualNetworkRule: Gets or Lists Azure Data Lake Store virtual network rule.</span></span>
    - <span data-ttu-id="b13c9-710">Add-AzDataLakeStoreVirtualNetworkRule : Ajoute une règle de réseau virtuel au compte Data Lake Store spécifié.</span><span class="sxs-lookup"><span data-stu-id="b13c9-710">Add-AzDataLakeStoreVirtualNetworkRule: Adds a virtual network rule to the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="b13c9-711">Set-AzDataLakeStoreVirtualNetworkRule : Modifie la règle de réseau virtuel spécifiée dans le compte Data Lake Store spécifié.</span><span class="sxs-lookup"><span data-stu-id="b13c9-711">Set-AzDataLakeStoreVirtualNetworkRule: Modifies the specified virtual network rule in the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="b13c9-712">Remove-AzDataLakeStoreVirtualNetworkRule : Supprime une règle de réseau virtuel Azure Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="b13c9-712">Remove-AzDataLakeStoreVirtualNetworkRule: Deletes an Azure Data Lake Store virtual network rule.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="b13c9-713">Az.Network</span><span class="sxs-lookup"><span data-stu-id="b13c9-713">Az.Network</span></span>
* <span data-ttu-id="b13c9-714">Mise à jour de la cmdlet Test-AzNetworkWatcherConnectivity, transmission de la valeur du protocole au serveur principal.</span><span class="sxs-lookup"><span data-stu-id="b13c9-714">Update cmdlet Test-AzNetworkWatcherConnectivity, pass the protocol value to backend.</span></span>
* <span data-ttu-id="b13c9-715">Ajout d’un complémenteur d’argument ResourceName pour tous les applets de commande.</span><span class="sxs-lookup"><span data-stu-id="b13c9-715">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azresources"></a><span data-ttu-id="b13c9-716">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="b13c9-716">Az.Resources</span></span>
* <span data-ttu-id="b13c9-717">Résolution des problèmes où Get-AzRoleDefinition cause une exception inintelligible (lorsque le profil par défaut ne contient aucun abonnement et qu’aucune portée n’est spécifiée) en ajoutant une exception explicite dans le scénario.</span><span class="sxs-lookup"><span data-stu-id="b13c9-717">Fix isssue where Get-AzRoleDefinition throws an unintelligible exception (when the default profile has no subscription in it and no scope is specified) by adding a meaningful exception in the scenario.</span></span> <span data-ttu-id="b13c9-718">Définit également le paramètre par défaut sur « RoleDefinitionNameParameterSet ».</span><span class="sxs-lookup"><span data-stu-id="b13c9-718">Also set the default param set to 'RoleDefinitionNameParameterSet'.</span></span>

## <a name="030---october-2018"></a><span data-ttu-id="b13c9-719">0.3.0 - Octobre 2018</span><span class="sxs-lookup"><span data-stu-id="b13c9-719">0.3.0 - October 2018</span></span>
#### <a name="azurestorage"></a><span data-ttu-id="b13c9-720">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="b13c9-720">Azure.Storage</span></span>
* <span data-ttu-id="b13c9-721">Correction d’un problème où le fichier/objet blob de copie ne copie pas les métadonnées lorsque la destination contient des problèmes de métadonnées</span><span class="sxs-lookup"><span data-stu-id="b13c9-721">Fix Copy Blob/File won't copy metadata when destination has metadata issue</span></span>
    - <span data-ttu-id="b13c9-722">Start-AzureStorageBlobCopy</span><span class="sxs-lookup"><span data-stu-id="b13c9-722">Start-AzureStorageBlobCopy</span></span>
    - <span data-ttu-id="b13c9-723">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="b13c9-723">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="b13c9-724">Prise en charge de l’obtention de l’utilisation d’une ressource de stockage d’un emplacement spécifique, et de l’ajout de message d'avertissement où l’obtention de l’utilisation d’une ressource de stockage globale est obsolète.</span><span class="sxs-lookup"><span data-stu-id="b13c9-724">Support get the Storage resource usage of a specific location, and add warning message for get global Storage resource usage is obsolete.</span></span>
    - <span data-ttu-id="b13c9-725">Get-AzStorageUsage</span><span class="sxs-lookup"><span data-stu-id="b13c9-725">Get-AzStorageUsage</span></span>
    
#### <a name="azcognitiveservices"></a><span data-ttu-id="b13c9-726">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="b13c9-726">Az.CognitiveServices</span></span>
* <span data-ttu-id="b13c9-727">Prise en charge de Get-AzCognitiveServicesAccountSkus sans compte existant.</span><span class="sxs-lookup"><span data-stu-id="b13c9-727">Support Get-AzCognitiveServicesAccountSkus without an existing account.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="b13c9-728">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="b13c9-728">Az.Compute</span></span>
* <span data-ttu-id="b13c9-729">Correction de Get-AzVM -ResourceGroupName <rg> pour renvoyer plus de 50 résultats si besoin</span><span class="sxs-lookup"><span data-stu-id="b13c9-729">Fix Get-AzVM -ResourceGroupName <rg> to return more than 50 results if needed</span></span>
* <span data-ttu-id="b13c9-730">Ajout d’un exemple de la commande « SimpleParameterSet » à l’aide de la cmdlet New-AzVmss.</span><span class="sxs-lookup"><span data-stu-id="b13c9-730">Added an example of the 'SimpleParameterSet' to New-AzVmss cmdlet help.</span></span>
* <span data-ttu-id="b13c9-731">Correction d’une faute de frappe dans le message de progression d’Azure Disk Encryption</span><span class="sxs-lookup"><span data-stu-id="b13c9-731">Fixed a typo in the Azure Disk Encryption progress message</span></span>

#### <a name="azdatafactoryv2"></a><span data-ttu-id="b13c9-732">Az.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="b13c9-732">Az.DataFactoryV2</span></span>
* <span data-ttu-id="b13c9-733">Mise à jour de la version du Kit de développement logiciel (SDK) ADF .Net vers la version 2.3.0.</span><span class="sxs-lookup"><span data-stu-id="b13c9-733">Updated the ADF .Net SDK version to 2.3.0.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="b13c9-734">Az.Network</span><span class="sxs-lookup"><span data-stu-id="b13c9-734">Az.Network</span></span>
* <span data-ttu-id="b13c9-735">Ajout de la fonctionnalité NetworkProfile.</span><span class="sxs-lookup"><span data-stu-id="b13c9-735">Added NetworkProfile functionality.</span></span> <span data-ttu-id="b13c9-736">nouvelles cmdlets ajoutées</span><span class="sxs-lookup"><span data-stu-id="b13c9-736">new cmdlets added</span></span>
    - <span data-ttu-id="b13c9-737">Get-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="b13c9-737">Get-AzNetworkProfile</span></span>
    - <span data-ttu-id="b13c9-738">New-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="b13c9-738">New-AzNetworkProfile</span></span>
    - <span data-ttu-id="b13c9-739">Remove-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="b13c9-739">Remove-AzNetworkProfile</span></span>
    - <span data-ttu-id="b13c9-740">Set-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="b13c9-740">Set-AzNetworkProfile</span></span>
    - <span data-ttu-id="b13c9-741">New-AzContainerNicConfig</span><span class="sxs-lookup"><span data-stu-id="b13c9-741">New-AzContainerNicConfig</span></span>
    - <span data-ttu-id="b13c9-742">New-AzContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="b13c9-742">New-AzContainerNicConfigIpConfig</span></span>
* <span data-ttu-id="b13c9-743">Ajout d’un lien d’association de service sur le modèle de sous-réseau</span><span class="sxs-lookup"><span data-stu-id="b13c9-743">Added service association link on Subnet Model</span></span>
* <span data-ttu-id="b13c9-744">Ajout des cmdlets New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span><span class="sxs-lookup"><span data-stu-id="b13c9-744">Added cmdlet New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span></span>
* <span data-ttu-id="b13c9-745">Ajout des cmdlets Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span><span class="sxs-lookup"><span data-stu-id="b13c9-745">Added cmdlet Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span></span>

#### <a name="azrediscache"></a><span data-ttu-id="b13c9-746">Az.RedisCache</span><span class="sxs-lookup"><span data-stu-id="b13c9-746">Az.RedisCache</span></span>
* <span data-ttu-id="b13c9-747">Autorisez toutes les chaînes en tant que Paramètre de taille à progresser.</span><span class="sxs-lookup"><span data-stu-id="b13c9-747">Allow any string as Size parameter going forward.</span></span> <span data-ttu-id="b13c9-748">Ajout de P5 dans la fenêtre contextuelle PSArgumentCompleter</span><span class="sxs-lookup"><span data-stu-id="b13c9-748">Add P5 in PSArgumentCompleter popup</span></span>

#### <a name="azresources"></a><span data-ttu-id="b13c9-749">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="b13c9-749">Az.Resources</span></span>
* <span data-ttu-id="b13c9-750">Ajout du paramètre manquant -Mode à Set-AzPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="b13c9-750">Add missing -Mode parameter to Set-AzPolicyDefinition</span></span>
* <span data-ttu-id="b13c9-751">Correction d’un bogue de la cmdlet Get-AzProviderOperation pour les opérations avec Origin comprenant un utilisateur</span><span class="sxs-lookup"><span data-stu-id="b13c9-751">Fix Get-AzProviderOperation commandlet bug for operations with Origin containing User</span></span>

#### <a name="azsql"></a><span data-ttu-id="b13c9-752">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="b13c9-752">Az.Sql</span></span>
* <span data-ttu-id="b13c9-753">Correction d’un problème où certaines cmdlets ne reconnaissaient pas l’abonnement Azure actuel</span><span class="sxs-lookup"><span data-stu-id="b13c9-753">Fixed issue where some backup cmdlets would not recognize the current azure subscription</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="b13c9-754">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="b13c9-754">Az.Websites</span></span>
* <span data-ttu-id="b13c9-755">Nouvelle cmdlet Get-AzWebAppContainerContinuousDeploymentUrl : obtient l’URL du webhook de déploiement continu de conteneur</span><span class="sxs-lookup"><span data-stu-id="b13c9-755">New Cmdlet Get-AzWebAppContainerContinuousDeploymentUrl - Gets the Container Continuous Deployment Webhook URL</span></span>
* <span data-ttu-id="b13c9-756">Nouvelles cmdlets New-AzWebAppContainerPSSession et Enter-WebAppContainerPSSession : démarrent une session PowerShell à distance dans une application de conteneur Windows</span><span class="sxs-lookup"><span data-stu-id="b13c9-756">New Cmdlets New-AzWebAppContainerPSSession and Enter-WebAppContainerPSSession  - Initiates a PowerShell remote session into a windows container app</span></span>

## <a name="020---september-2018"></a><span data-ttu-id="b13c9-757">0.2.0 - Septembre 2018</span><span class="sxs-lookup"><span data-stu-id="b13c9-757">0.2.0 - September 2018</span></span>
 <span data-ttu-id="b13c9-758">Version initiale</span><span class="sxs-lookup"><span data-stu-id="b13c9-758">Initial Release</span></span>