...
Azure PowerShell version 6.0.0 requiert la version 5.0 (ou une version ultérieure) de PowerShell. Les versions précédentes d’Azure PowerShell requièrent _au moins_ la version 3.0 de PowerShell pour exécuter un applet de commande. Pour plus d’informations sur la mise à niveau vers PowerShell 5.0, consultez [ce tableau](/powershell/scripting/setup/installing-windows-powershell?view=powershell-6#upgrading-existing-windows-powershell).
