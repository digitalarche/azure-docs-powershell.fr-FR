...
* Calcul
    ...
    - Ajout - Prise en charge AsJob pour les applets de commande de calcul longues. Permet aux applets de commande sélectionnées de s’exécuter en arrière-plan et de retourner une tâche pour suivre et contrôler la progression.
