...
Azure PowerShell est également disponible à partir d’Azure Cloud Shell.

Utilisez [Azure Cloud Shell](/azure/cloud-shell/overview) pour exécuter Azure PowerShell dans votre navigateur ou [l’installer en local](install-az-ps.md). Consultez l’article de [prise en main](get-started-azureps.md) pour découvrir les bases d’Azure PowerShell et la prise en main d’Azure.
...
Si vous n’êtes pas familiarisé avec PowerShell, une introduction à ce logiciel peut s’avérer opportune.
