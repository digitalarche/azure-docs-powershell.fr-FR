...
Dans cet exemple, nous obtenons une liste des machines virtuelles Azure présentes dans notre abonnement par défaut.  Par défaut, la commande `Get-AzVM` présente la sortie sous forme de tableau.
