...
### <a id="update-azps"></a><span data-ttu-id="625dc-149">Mise à jour vers une nouvelle version d’Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="625dc-149">Updating to a new version of Azure PowerShell</span></span>
